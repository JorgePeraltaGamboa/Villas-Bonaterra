...
var helpers = {
	/**
	 * An empty function that can be used, for , for optional callback.
	 */
	noop: function() {},
 ...
 * for  because of `display: none` on a parent node.
...
module.exports = {
	...
	acquireContext: function(item, config) {
		...
		// method, for : https://github.com/kkapsner/CanvasBlocker
		// https://github.com/chartjs/Chart.js/issues/2807
 ...
 * returns the associated `tkey` value. For , interpolate(table, 'time', 42, 'pos')
...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		 ...
		 * @private
		 */
		getLabelCapacity: function(Time) {
			var me = this;

			var formatOverride = me.options.time.displayFormats.millisecond;	// Pick the longest format for guestimation

			var Label = me.tickFormatFunction(moment(Time), 0, [], formatOverride);
			var tickLabelWidth = me.getLabelWidth(Label);
