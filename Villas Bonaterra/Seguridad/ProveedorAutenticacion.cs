...
namespace VillasBonaterra.Seguridad
{
    public class ProveedorAutenticacion : MembershipProvider
    {
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            {
                var user = db.Usuario.FirstOrDefault(o => o.login.ToLower() == username.ToLower());

                if (user == null) {
                    user = db.Usuario.FirstOrDefault(o => o.email.ToLower() == username.ToLower());
                }
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            using (var db = new Villas_BonaterraEntities()) {
                ...
                if (db.Usuario.Any(o => o.password == pass && o.login == username)) {
                    return true;
                }

                return db.Usuario.Any(o => o.password == pass && o.email == username);
